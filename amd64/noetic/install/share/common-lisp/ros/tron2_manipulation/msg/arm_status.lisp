...
(cl:defmethod cl:initialize-instance :after ((m <arm_status>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'arm_status)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tron2_manipulation-msg:<arm_status> is deprecated: use tron2_manipulation-msg:arm_status instead.")))
