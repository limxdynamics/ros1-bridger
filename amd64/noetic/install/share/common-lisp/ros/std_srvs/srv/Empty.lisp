...
(cl:defmethod cl:initialize-instance :after ((m <Empty-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Empty-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<Empty-request> is deprecated: use std_srvs-srv:Empty-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Empty-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Empty-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<Empty-response> is deprecated: use std_srvs-srv:Empty-response instead.")))
