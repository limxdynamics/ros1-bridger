...
(cl:defmethod cl:initialize-instance :after ((m <GetInt32-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetInt32-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<GetInt32-request> is deprecated: use std_srvs-srv:GetInt32-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetInt32-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetInt32-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<GetInt32-response> is deprecated: use std_srvs-srv:GetInt32-response instead.")))
