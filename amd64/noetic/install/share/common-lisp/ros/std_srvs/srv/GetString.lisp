...
(cl:defmethod cl:initialize-instance :after ((m <GetString-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetString-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<GetString-request> is deprecated: use std_srvs-srv:GetString-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetString-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetString-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<GetString-response> is deprecated: use std_srvs-srv:GetString-response instead.")))
