...
(defsystem "controller_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "JointCmdLimx" :depends-on ("_package_JointCmdLimx"))
    (:file "_package_JointCmdLimx" :depends-on ("_package"))
    (:file "JointCmdNew" :depends-on ("_package_JointCmdNew"))
    (:file "_package_JointCmdNew" :depends-on ("_package"))
