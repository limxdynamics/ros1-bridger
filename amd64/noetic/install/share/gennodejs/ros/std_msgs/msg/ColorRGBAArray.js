...
class ColorRGBAArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.data.forEach((val) => {
      bufferOffset = ColorRGBA.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ColorRGBAArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = ColorRGBA.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static datatype() {
    ...
    return 'std_msgs/ColorRGBAArray';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ColorRGBAArray(null);
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = ColorRGBA.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
