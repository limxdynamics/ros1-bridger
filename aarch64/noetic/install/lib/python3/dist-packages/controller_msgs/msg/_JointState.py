...
"""autogenerated by genpy from controller_msgs/JointState.msg. Do not edit."""
import codecs
import sys
...
class JointState(genpy.Message):
  _md5sum = "0d1d997e638ba23ee585b83a152596fe"
  _type = "controller_msgs/JointState"
...
string frame_id
"""
  __slots__ = ['header','names','q','v','vd','tau','na']
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.vd = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
