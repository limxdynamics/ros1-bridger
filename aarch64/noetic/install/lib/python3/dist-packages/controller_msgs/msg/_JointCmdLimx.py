...
"""autogenerated by genpy from controller_msgs/JointCmdLimx.msg. Do not edit."""
import codecs
import sys
...
class JointCmdLimx(genpy.Message):
  _md5sum = "aa66c708f26b270ba9c935d9e8db6182"
  _type = "controller_msgs/JointCmdLimx"
...
string frame_id
"""
  __slots__ = ['header','names','q','v','tau','kp','kd','mode','na','parallel_solver_mode']
  _slot_types = ['std_msgs/Header','string[]','float32[]','float32[]','float32[]','float32[]','float32[]','uint8[]','uint32','uint8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,names,q,v,tau,kp,kd,mode,na,parallel_solver_mode
    ...
    """
    if args or kwds:
      super(JointCmdLimx, self).__init__(*args, **kwds)
      ...
      if self.na is None:
        self.na = 0
      if self.parallel_solver_mode is None:
        self.parallel_solver_mode = b''
    else:
      self.header = std_msgs.msg.Header()
      self.names = []
      self.q = []
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.parallel_solver_mode = str[start:end]
      return self
