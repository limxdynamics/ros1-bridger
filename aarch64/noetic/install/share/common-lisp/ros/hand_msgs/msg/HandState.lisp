...
(cl:defmethod cl:initialize-instance :after ((m <HandState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HandState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hand_msgs-msg:<HandState> is deprecated: use hand_msgs-msg:HandState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <HandState>))
...
(cl:defmethod hand_type-val ((m <HandState>))
...
(cl:defmethod ctrl_mode-val ((m <HandState>))
...
(cl:defmethod hand_state-val ((m <HandState>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HandState>)))
  ...
  "0e859982707a5c9b2e1da5a16bffb891")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HandState)))
  "Returns md5sum for a message object of type 'HandState"
  "0e859982707a5c9b2e1da5a16bffb891")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HandState>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%string hand_type~%~%uint8[2] ctrl_mode~%~%HandMsg[2] hand_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: hand_msgs/HandMsg~%std_msgs/Header header~%~%string[]  names~%float32[] pos~%float32[] vel~%float32[] current~%float32[] time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HandState)))
  "Returns full string definition for message of type 'HandState"
  (cl:format cl:nil "std_msgs/Header header~%string hand_type~%~%uint8[2] ctrl_mode~%~%HandMsg[2] hand_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: hand_msgs/HandMsg~%std_msgs/Header header~%~%string[]  names~%float32[] pos~%float32[] vel~%float32[] current~%float32[] time~%~%~%"))
