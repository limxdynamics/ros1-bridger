...
(cl:defmethod cl:initialize-instance :after ((m <KeyPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teleop_msgs-msg:<KeyPoint> is deprecated: use teleop_msgs-msg:KeyPoint instead.")))
...
(cl:defmethod pose-val ((m <KeyPoint>))
