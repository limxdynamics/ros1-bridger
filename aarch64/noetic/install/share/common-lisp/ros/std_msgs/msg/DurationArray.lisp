...
(cl:defclass <DurationArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector std_msgs-msg:Duration)
   :initform (cl:make-array 0 :element-type 'std_msgs-msg:Duration :initial-element (cl:make-instance 'std_msgs-msg:Duration))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DurationArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DurationArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_msgs-msg:<DurationArray> is deprecated: use std_msgs-msg:DurationArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DurationArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'std_msgs-msg:Duration))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DurationArray>)))
  ...
  "4b47656622a8026ba8097a096def7a9b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DurationArray)))
  "Returns md5sum for a message object of type 'DurationArray"
  "4b47656622a8026ba8097a096def7a9b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DurationArray>)))
  ...
  (cl:format cl:nil "Header  header   # header info~%Duration[]  data     # array of data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: std_msgs/Duration~%duration data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DurationArray)))
  "Returns full string definition for message of type 'DurationArray"
  (cl:format cl:nil "Header  header   # header info~%Duration[]  data     # array of data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: std_msgs/Duration~%duration data~%~%~%"))
