...
(cl:defmethod cl:initialize-instance :after ((m <GetBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<GetBool-request> is deprecated: use std_srvs-srv:GetBool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<GetBool-response> is deprecated: use std_srvs-srv:GetBool-response instead.")))
