...
(cl:defmethod cl:initialize-instance :after ((m <SetString-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetString-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<SetString-request> is deprecated: use std_srvs-srv:SetString-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetString-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetString-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_srvs-srv:<SetString-response> is deprecated: use std_srvs-srv:SetString-response instead.")))
