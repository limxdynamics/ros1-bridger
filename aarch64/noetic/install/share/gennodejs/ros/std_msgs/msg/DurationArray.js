...
class DurationArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.data.forEach((val) => {
      bufferOffset = Duration.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DurationArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = Duration.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static datatype() {
    ...
    return 'std_msgs/DurationArray';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '4b47656622a8026ba8097a096def7a9b';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DurationArray(null);
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = Duration.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
