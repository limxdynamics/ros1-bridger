...
class JointCmdNew {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.mode = null;
      this.na = null;
      this.parallel_solve_required = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('parallel_solve_required')) {
        this.parallel_solve_required = initObj.parallel_solve_required
      }
      else {
        this.parallel_solve_required = [];
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [parallel_solve_required]
    bufferOffset = _arraySerializer.bool(obj.parallel_solve_required, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [parallel_solve_required]
    data.parallel_solve_required = _arrayDeserializer.bool(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += object.parallel_solve_required.length;
    return length + 36;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JointCmdNew(null);
    ...
    if (msg.parallel_solve_required !== undefined) {
      resolved.parallel_solve_required = msg.parallel_solve_required;
    }
    else {
      resolved.parallel_solve_required = []
    }
